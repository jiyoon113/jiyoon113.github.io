...
\begin{itemize}
    ...
    \item \small{\textbf{멀티모달 인공지능 모델의 잠재 공간 프라이버시 누출 증폭 진단 및 방어 방법, 및 장치} \\
    박찬준, \textbf{장지윤} \\
    \textit{Korean Patent Application, filed on August 24, 2026 (Application No. 10-2026-0159261).}}
\end{itemize}
...
\begin{itemize}
    ...
    \item \small{General Scholarship (Departmental Recommendation), Soongsil University (2026)}
\end{itemize}
